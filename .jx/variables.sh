...
export JENKINS_X_URL='https://dashboard-jx.dev.jenkins-x.me/jenkins-x-charts/local-external-secrets/main/4'
...
export MINK_IMAGE='ghcr.io/jenkins-x/local-external-secrets:0.0.14'
